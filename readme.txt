...
> NOTE: the following files are auto-generated by the `npm run release` command, DO NOT MODIFY as they will be overwritten on every build:
> 
> - `README.md`
> - `js/index.asset.php`
> - `build/`
...
1. Develop: start test WordPress Docker container
...
3. Clean: Destroys test WordPress Docker container and removes build folder. WARNING - Destructive
